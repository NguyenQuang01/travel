    ...
    <Container className="my-10">
      ...
      <div className="flex items-start p-6 bg-white rounded-2xl shadow-lg  mt-10">
        <Image
          ...
          priority={true}
          loading="eager"
          className="md:w-[80px]  md:h-[80px] h-[40px] w-[40px] object-cover rounded-full mr-5"
        />
        ...
        <div className="flex-1 md:mt-5">
          ...
          <p className="text-gray-600 mt-2">
            All you need to do is answer a few questions about the trip you're
            dreaming of. Travelstride will use your input to match you with a
            local travel planner who can help make your trip a reality.
          </p>
