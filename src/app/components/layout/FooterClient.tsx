...
export default function Footer() {
    return (
        <footer className="bg-[#dcdcdc99] text-gray-700 pb-10 mt-80">
            <div className="container mx-auto px-6 md:px-12 pt-20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-sm text-gray-600">
                            Travelstride helps you search and compare 50,000+
                            expert-planned trips from 1,000+ companies. Get the
                            real picture with both traveler and expert reviews.
                        </p>
                    </div>
                ...
                <div className="mt-10 border-t pt-6 text-center">
                    <h3 className="text-sm font-semibold text-gray-700">
                        Tours & Operators on Travelstride Awarded and Featured
                        by:
                    </h3>
