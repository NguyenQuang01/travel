          ...
          <Col xs={24} md={16}>
            <div className="flex flex-col md:flex-row items-start p-4 md:p-6 bg-white rounded-2xl shadow-lg mt-10">
              ...
              <div className="flex-1 w-full">
                <h2 className="font-semibold text-lg">Who is traveling?</h2>
                ...
                <Select
                  ...
                  onChange={(value) => setTripData({ numTravelers: value })}
                      ...
                      <input
                        ...
                        onChange={() => {
                          const agesArray = selectedAges
                            ? selectedAges.split(",")
                            : [];
                          const newAges = agesArray.includes(age)
                            ? agesArray.filter((a) => a !== age).join(",")
                            : [...agesArray, age].join(",");
