      ...
      <Container className="my-10">
        ...
        <Row gutter={[16, 16]} className="mt-10">
          <Col xs={24} md={16}>
            ...
            <div className="flex flex-col md:flex-row mx-auto p-4 md:p-6 bg-white shadow-md rounded-lg mt-10">
              <Image
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {lodgingOptions.map(({ id, label, img }) => (
                    <label
                      key={id}
                      className={`flex items-center space-x-3 p-3 md:p-4 cursor-pointer border-2 rounded-lg w-full ${
                    ...
                    >
                      <div className="flex flex-col w-full">
                        <Image
                          ...
                          width={200}
                          height={130}
                          className="rounded-md mb-2 h-24 md:h-30 w-full object-cover"
                        />
                        <div className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            checked={
                              tripData?.lodgingType?.split(",")?.includes(id) ||
                              false
                            }
                            onChange={() => handleSelection(id)}
                            className="w-4 md:w-5 h-4 md:h-5 accent-green-600"
                          />
